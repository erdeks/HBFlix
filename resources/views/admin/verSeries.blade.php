            ...
            <div class="container " style="background-color: #2E3637; border-radius: 8px;">
              ...
              @foreach( $arraySeries as $key => $serie )
                <div class="hijo" style="margin-top: 5%; float: left; padding: 3.1%;">
                  <a class="btn btn-sm btn-success" href="{{ url('/admin/verSer/' . $serie->id ) }}" style="margin: 5px;">
                      <i class="glyphicon glyphicon-pencil"></i>
                  </a>
                  <a class="btn btn-sm btn-info" href="{{ url('/admin/verSer/' . $serie->id ) }}" style="margin: 5px;">
                      <i class="glyphicon glyphicon-zoom-in"></i>
                  </a>
                  <a class="btn btn-sm btn-danger" href="{{url('/admin/eliminarSerie/'.$serie->id ) }}" style="margin: 5px;">
